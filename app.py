...
def home():
    try:
        return jsonify(message="Hey welcome I am running. Use /analyze/text  use %20 for blank spaces.")
...
def analyze_sentiment(input_txt):
    try:
        ...
        logger.error(f"Error in Sentiment analysis /analyze/<input_txt> route: {str(e)}")
        return jsonify(error="Internal Server Error"), 500  
